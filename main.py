...
def extract_usps_labels_files(filesPaths):
...
def LR():
	...
	isTraining = False
	noOfItr = 1
	usps_data,usps_labels_training = extract_labels_files(files)
	_,accuracy,_ = process_input(usps_data,usps_labels_training,trained_weight,isTraining,noOfItr,final_lambda,final_eta)
	...
	usps_data_test,usps_labels_test = extract_labels_files(files_test)
	_,accuracy,_ = process_input(usps_data_test,usps_labels_test,trained_weight,isTraining,noOfItr,final_lambda,final_eta)
